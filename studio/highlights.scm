...
; end @variable.builtin @keyword.directive @variable.member.oref @constant.builtin (blue fg, default bg)
 ...
 ; start @keyword.operator (purple fg)
[
...
; end  @keyword.operator (purple fg)
...
(pound_if_special_case) @comment.untouched
...
(command_zload
  (expression
    [
      (expr_atom 
      [
        (lvn (objectscript_identifier) @label) 
        (lvn (objectscript_identifier_special) @label) 
        ...
        [
          ...
          (oref_chain_segment 
            (oref_property 
              (property_name 
                (identifier_segment_immediate) @label
              ) @label
            )
          ) @label
        )
